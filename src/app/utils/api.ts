export class Api {
    ...
    static DATA_FORM_CONFIG = Api.DATA_BASE_END_POINT + 'utils/register-config-form';
    ...
    static GAME = 'wss://demo-game.debugger.pl';
    static GAME_GET_USER = '//demo-game.debugger.pl/get-user';
    static GAME_REGISTER_USER = '//demo-game.debugger.pl/register';
}